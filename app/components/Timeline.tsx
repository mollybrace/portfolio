...
const Timeline = () => {
  ...
  <li>
    ...
    <div className="timeline-start mb-10 md:text-end">
      ...
      <div>I work with clients to design, plan and develop responsive web pages.</div>
    <div className="text-lg font-black">Freelance Yoga Instructor</div>
  ...
  <li>
    ...
    <div className="timeline-end mb-10">
      ...
      <div>Full-stack software engineering bootcamp covering the fundamentals of CSS, HTML, JavaScript, Test Driven Development and Agile development practices. </div>
  ...
  <li>
    ...
    <div className="timeline-end mb-10">
      ...
      I have established a global student base of 500+ students as an online 1:1 tutor.
    </div>
  ...
  <li>
    ...
    <div className="timeline-start mb-10 md:text-end">
      ...
      <div className='text-gray-400'>Social Fox</div>
        <ul>
            <li>During the first Covid lockdown in Thailand I started working for an Australian based digital marketing agency remotely from Thailand.</li>
        </ul>
    </div>
  </li>
  <li>
